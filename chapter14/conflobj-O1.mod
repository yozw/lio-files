## # Conflicting objectives: producing versus importing; model (O1)
...
var z;				# total profit variable 
var w;				# total import costs
...
subject to mtime: sum{k in 1..K} rm[k] * x[k] <= RM;
